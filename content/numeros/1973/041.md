...
artistas = ["Joe Cocker", "Edgar Winter", "Argent", "Carly Simon", "James Taylor", "Vox Dei", "Willy Quiroga", "Ricardo Soulé", "Rubén Basoalto", "Javier Martínez", "Manal", "Montes Mahatma", "King Crimson", "Peter Frampton", "Camello", "Eagles", "Moody Blues", "Bob Dylan", "Kris Kristofferson", "Sam Peckinpah", "Eric Clapton", "Sui Géneris", "Charly García", "Nito Mestre", "Moris", "Atlantis", "El Reloj", "Ensamble Musical de Buenos Aires", "Pajarito Zaguri", "Litto Nebbia", "John Mayall", "Ara Tokatlian", "Enrique 'Mono' Villegas", "Jorge Pinchevsky"]
...
Avisos Libres. En Cartel. Discos. Historieta: Golan Tarma (Por Jorge Pistocchi). Correo. Variedades: La Biblia por el Ensamble Musical de Buenos Aires, Pajarito Zaguri, Litto Nebbia, Revista Pelo, John Mayall, Ara Tokatlian, Enrique 'Mono' Villegas, Jorge Pinchevsky.
