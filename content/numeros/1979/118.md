...
artistas = ["Queen", "Led Zeppelin", "Allman Brothers", "Roger McGuinn", "Chris Hillman", "Gene Clark", "Leo Sujatovich", "Beto Satragni", "Juan Carlos 'Mono' Fontana", "Alfredo Toth", "Rodolfo Gorosito", "Ciro Fogliatta", "María Rosa Yorio", "Jan Hammer", "Jeff Corbin", "Marcelo Houseman", "Néstor Briyo", "Aschavel", "Serú Girán"] 
...
**Reportajes**: Allman Brothers. Roger McGuinn, Chris Hillman y Gene Clark. 

**Entrevistas**:  Leo Sujatovich. Beto Satragni.

**Notas sobre**:

- Currículum: Los Desconocidos de Siempre. Juan Carlos 'Mono' Fontana, Alfredo Toth, Rodolfo Gorosito, Ciro Fogliatta, María Rosa Yorio.
- Jan Hammer.
